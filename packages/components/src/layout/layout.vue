...
import type { VbenLayoutProps } from './props'

import { useCssVar, useMouse, useScroll, useThrottleFn } from '@vueuse/core'
...
import { CSS_VARIABLE_LAYOUT_FOOTER_HEIGHT, CSS_VARIABLE_LAYOUT_HEADER_HEIGHT, ELEMENT_ID_MAIN_CONTENT, SCROLL_FIXED_CLASS } from './constan'
...
<template>
  <div class="relative flex min-h-full w-full">
    ...
    <div
      v-if="maskVisible"
      :style="maskStyle"
      class="bg-overlay absolute left-0 top-0 h-full w-full transition-[background-color] duration-200"
